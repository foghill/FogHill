...
private slots:
    ...
    QString BuyFOG(QString OrderType, double Quantity, double Rate);
    QString SellFOG(QString OrderType, double Quantity, double Rate);
