...
int nAnonymizeFog_HillAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Fog_Hill
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Fog_Hill
    // Mac: ~/Library/Application Support/Fog_Hill
    // Unix: ~/.Fog_Hill
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Fog_Hill";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Fog_Hill.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Fog_Hilld.pid"));
